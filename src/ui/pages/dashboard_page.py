...
class DashboardPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.card_low = self._create_stat_card(
            "Low Stock Alerts", "0", COLORS["yellow"], COLORS["yellow_soft"], "\u26A0"
        )
        self.card_categories = self._create_stat_card(
            "Categories", "7", COLORS["purple"], COLORS["purple_soft"], "\u2726"
        )

        cards_row1.addWidget(self.card_total)
        cards_row1.addWidget(self.card_value)
        cards_row1.addWidget(self.card_low)
        cards_row1.addWidget(self.card_categories)
    ...
    def _update_dashboard(self, data):
        ...
        self.card_low._value_label.setText(str(stats['low_stock_count']))
