...
class LensPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.category = self.inventory_service.get_category_by_name("Camera Lens")
    ...
    def _setup_ui(self):
        ...
        self.filter_combo.addItems(["iPhone Lens", "Android Lens"])
