...
class TransactionService:
    ...
    def record_purchase(
        ...
        # Update purchase price to weighted average when new units are added
        old_cost = (product.purchase_price or 0) * product.quantity
        new_cost = unit_price * quantity
        total_cost = old_cost + new_cost
        total_quantity = product.quantity + quantity
        product.purchase_price = total_cost / total_quantity if total_quantity > 0 else unit_price
